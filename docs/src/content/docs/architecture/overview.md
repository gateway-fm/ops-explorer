...
|---------|----------|-------------|
| **chain-indexer** | Go | Polls an RPC node and indexes chain data into PostgreSQL. Lives in a [separate repo](https://github.com/gateway-fm/chain-indexer); exposes data over gRPC. |
...
configuration, including how the explorer integrates with privacy-proxy.
